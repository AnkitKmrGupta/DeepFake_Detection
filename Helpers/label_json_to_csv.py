...
for i in range(8):
    path_json = "C:\project\FF_Dataset\Kaggle dataset\dfdc_train_part_"+str(i)+"\metadata.json"
    path_csv = "C:\project\FF_Dataset\Kaggle dataset\dfdc_train_part_"+str(i)+"\metadata.csv"
    print(path_csv)
    print(path_json)
